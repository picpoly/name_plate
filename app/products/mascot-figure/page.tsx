...
export default function MascotFigurePage() {
  ...
  // 商品画像の配列
  const productImages = [
    { src: "/animal-character-figure.png", alt: "マスコットフィギュア例 1" },
    // 2枚目の画像を削除
    { src: "/ice-cream-mascot.png", alt: "アイスクリームマスコットフィギュア" },
    { src: "/frog-prince-mascot.jpeg", alt: "カエル王子マスコットフィギュア" },
    { src: "/cloud-mascot.jpeg", alt: "雲マスコットフィギュア" },
    { src: "/plant-mascot.png", alt: "植物マスコットフィギュア" },
    { src: "/mouse-mascots.png", alt: "ネズミマスコットフィギュア" },
    { src: "/corgi-mascot.jpeg", alt: "コーギーマスコットフィギュア" },
  ]

  // 現在表示中のメイン画像を管理するステート
  const [currentMainImage, setCurrentMainImage] = useState("/animal-character-figure.png")
  ...
  const openQuoteForm = () => {
    // 画像アップロードのバリデーション
    if (!uploadedFile) {
      setUploadError("キャラクター画像のアップロードは必須です。")
      // アップロードセクションまでスクロール
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          {/* 商品情報 */}
          <div className="w-full md:w-1/2">
            <h1 className="text-3xl font-bold mb-2">マスコットフィギュア</h1>

            <Alert className="mb-4">
              <AlertCircle className="h-4 w-4" />
              <AlertTitle>見積もり依頼について</AlertTitle>
              <AlertDescription>
                マスコットフィギュアは見積もりが必要な商品です。小物や装飾が多い場合は追加料金が発生する場合があります。
            ...
            <Tabs id="product-tabs" defaultValue="price" value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="details" className="pt-4">
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>企業マスコットやオリジナルキャラクターを立体化</li>
                  <li>かわいらしいデフォルメスタイル</li>
                  <li>高品質な3Dプリント技術で細部まで再現</li>
                  <li>丈夫で長持ちする素材を使用</li>
                  <li>プロモーションやギフトに最適</li>
                  <li>イベントやキャンペーンの景品としても人気</li>
                  <li>オリジナルデザインで他にはない特別な一品</li>
                </ul>

                <div className="mt-6">
                  <h3 className="font-medium mb-3">1枚のイラストからフィギュアに！</h3>
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="relative aspect-square rounded overflow-hidden">
                      <Image
                        src="/ice-cream-mascot.png"
                        alt="アイスクリームマスコットフィギュア - イラスト"
                        fill
                        className="object-contain"
                      />
                    </div>
                    <div className="relative aspect-square rounded overflow-hidden">
                      <Image
                        src="/ice-cream-mascot-side.jpeg"
                        alt="アイスクリームマスコットフィギュア - 完成品"
                        fill
                        className="object-contain"
                      />
                    </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  ...
                  <div className="relative aspect-square rounded overflow-hidden">
                    <Image src="/cute-mascot.png" alt="マスコットフィギュア例2" fill className="object-contain" />
                  </div>
                </div>
              </TabsContent>
